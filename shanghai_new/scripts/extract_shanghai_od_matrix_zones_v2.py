...
SITES_CSV = DATA_DIR / "selected_sites_K30_v2.csv"
...
def main():
    ...
    sites_out.to_csv(OUT_DIR / f"shanghai_site_to_zone_v2_k{K}.csv", index=False)
    ...
    out_npz = OUT_DIR / f"shanghai_od_zones_v2_k{K}_30min_1channel.npz"
    ...
    out_adj = OUT_DIR / f"shanghai_adj_matrix_zones_v2_k{K}.csv"
