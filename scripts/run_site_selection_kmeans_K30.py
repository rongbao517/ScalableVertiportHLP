...
def main():
    ...
    ap.add_argument("--seed", type=int, default=SEED,
                     help="KMeans random_state -- vary this to measure how much site selection "
                          "itself is sensitive to K-means's own randomness, independent of the "
                          "demand input's quality.")
    args = ap.parse_args()
